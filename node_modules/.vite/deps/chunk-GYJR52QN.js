import {
  require_jsx_runtime
} from "./chunk-UUM5P6DH.js";
import {
  require_react
} from "./chunk-XVLTWXUQ.js";
import {
  __commonJS,
  __toESM
...
function ThemeProvider3(props) {
  ...
  const upperPrivateTheme = useTheme4() || EMPTY_THEME4;
  if (true) {
  ...
  const Grid2 = React22.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime13.jsx)(GridRoot, {
      ...
      children: React22.Children.map(children, (child) => {
        var _a;
        if (React22.isValidElement(child) && isMuiElement(child, ["Grid"]) && container2 && child.props.container) {
...
@mui/system/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-GYJR52QN.js.map
